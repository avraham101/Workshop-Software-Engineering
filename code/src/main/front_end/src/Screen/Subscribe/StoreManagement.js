...
class StoreManagement extends Component{
    constructor() {
        ...
        this.handleStores = this.handleStores(this);
        this.state = {
    ...
    render() {
        return (
            <BackGrond>
                ...
                <h4 style={style_sheet}>That will point you to the stores that you have permission to theme.</h4>
                <div>{this.render_permission()}</div>
                <div>
                    {this.state.showStores ? this.render_stores() : ""}
                </div>
            </BackGrond>
