        ...
        return (
            <BackGroud>
                ...
                <body>
                    ...
                    {this.renderProducts()}
                    <Input title = 'Choose amount to cart:' type = 'text' 
                           value = {this.state.amount} 
                           onChange = {this.handleChangedAmount}/>  
                    <div>
                        <Button color="primary" aria-label="add to shopping cart" text='add' 
                                onClick={(e) => (parseInt(this.state.amount) < product.amountInStore) ? 
                                    this.setState({enough:true}) : this.setState({enough:false}) } />
                        { this.state.enough === false?
                            <Error text='Close Me'/> : ''
                        }
                    </div>
                </body>
