        ...
        <table style={style_sheet}>
          <tr>
            ...
            <th
              ...
              onMouseLeave={() => this.setState({ color_3: "" })}
            >
              {" "}
              Register{" "}
            </th>
            <th
              ...
              onMouseLeave={() => this.setState({ color_4: "" })}
            >
              {" "}
              Login{" "}
            </th>
            <th
              ...
              onMouseLeave={() => this.setState({ color_5: "" })}
            >
              {" "}
              Watch My Cart{" "}
            </th>
